import { z } from "zod";
import { ApiResponse, fetchEmptyWithErrorHandling, fetchWithErrorHandling } from "./Errors";
...
export type ApiKeyWithSecretResponse = z.infer<typeof ApiKeyWithSecretResponseSchema>;
